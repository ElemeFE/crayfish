...
class FilterBar extends Jinkela {
  init() {
    new FilterBarTextField({ placeholder: 'path filter', name: 'path', onInput: this.onInput }).renderTo(this);
    new FilterBarTextField({ placeholder: 'name filter', name: 'name', onInput: this.onInput }).renderTo(this);
